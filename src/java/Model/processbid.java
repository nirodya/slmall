 ...
 */
@WebServlet(name = "processbid", urlPatterns = {"/processbid"})
public class processbid extends HttpServlet {
...
//                    }
                    ...
                    DB.Bidding b=new DB.Bidding();
                    b.setBidDate(new Date());
                    b.setUser(u);
                    b.setBidForDate(c.getTime());
                    b.setWiningValue(Double.parseDouble(request.getParameter("bidvalue")));
                    s.save(b);
