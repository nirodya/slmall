...
public class changepw extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String pasword = request.getParameter("newpw");
            ...
            changepassc.add(Restrictions.eq("email", email));
            
            DB.UserLogin changeul = (DB.UserLogin) changepassc.uniqueResult();
            CryptWithMD5 crpt = new CryptWithMD5();
            
            Transaction t=changepasssess.beginTransaction();
            changeul.setPassword(crpt.cryptWithMD5(pasword));
            t.commit();
