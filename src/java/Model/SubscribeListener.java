 ...
 */
@WebServlet(name = "SubscribeListener", urlPatterns = {"/SubscribeListener"})
public class SubscribeListener extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<DB.Subcription> sublist=sub.getSubcriptionFromUsers(u);
            Session s=Connection.Connection.getSessionFactory().openSession();
            for (Subcription sublist1 : sublist) {
                
            Criteria c=s.createCriteria(DB.SubcriptionHasStock.class);
            c.add(Restrictions.eq("subcription", sublist1));
            }
