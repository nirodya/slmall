    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           String mail=request.getParameter("email");
            ...
            if(ul!=null){
            Esender.emailsender(mail, "Forgot Password", "Please goto this link and change your password. http://localhost:8080/Shopping_mall/changepassword.jsp?pw="+ul.getPassword()+"&un="+mail);
            }
